...
import { VOUCHER_REPOSITORY, type IVoucherRepository, VoucherWithDetails } from '~/domain/repositories/voucher.repository.interface'
...
export class GetVoucherDetailByIdHandler implements IQueryHandler<GetVoucherDetailByIdQuery, VoucherWithDetails> {
  constructor(
