...
import { VOUCHER_REPOSITORY, type IVoucherRepository, VoucherWithUsedCount } from '~/domain/repositories/voucher.repository.interface'
...
export class GetShopVouchersHandler implements IQueryHandler<GetShopVouchersQuery, VoucherWithUsedCount[]> {
  constructor(
